...
namespace Game
{
    ...
    public abstract class GameWindow : Control
    {
        ...
        private bool simulationAfterCloseMenuWindow;
        ...
        protected override bool OnKeyDown(KeyEvent e)
        {
            ...
            if (GameMap.Instance.GameType == GameMap.GameTypes.AssaultKnights)
            {
                if (e.Key == EKeys.Enter)
                {
                    ...
                    {
                        Controls.Add(new PlayerSpawnWindow());
                        return true;
                    }
                    else
                    {
                        GameEngineApp.Instance.AddScreenMessage("You must leave vehicle first before selecting new spawn!");
                    }
                }
            }
        ...
        protected override void OnControlAttach(Control control)
        {
            ...
            else if (control as PlayerSpawnWindow != null || control as PlayerBuyWindow != null)
            {
                EngineApp.Instance.KeysAndMouseButtonUpAll();
