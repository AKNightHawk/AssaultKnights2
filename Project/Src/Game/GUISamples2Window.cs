...
namespace Game
{
    public class GUISamples2Window : Control
    {
        ...
        private int sceneBoxMeshIndex;

        private RenderToTexture renderToTexture = new RenderToTexture();
        ...
        private class RenderToTexture
        {
            ...
            private SceneRenderTargetListener renderTargetListener;
            ...
            private class SceneRenderTargetListener : RenderTargetListener
            {
                private RenderToTexture owner;
            ...
            private void BindToOutputControl()
            {
            ...
            private void UnbindToOutputControl()
            {
                if (outputControl != null)
                {
        ...
        private void SceneBoxChangeModel_Click(Button sender)
        {
        ...
        private void SceneBoxCreateParticle_Click(Button sender)
        {
