...
namespace Game
{
    public class RTSGameWindow : GameWindow
    {
        ...
        private Range cameraDistanceRange = new Range(10, 300);
        private Range cameraAngleRange = new Range(.001f, MathFunctions.PI / 2 - .001f);
        private float cameraDistance = 23;
        private SphereDir cameraDirection = new SphereDir(1.5f, .85f);
        ...
        private Vec2 selectStartPos;
        private bool selectDraggedMouse;

        //Task target choose
        private int taskTargetChooseIndex = -1;

        //Task target build Building
        private RTSBuildingType taskTargetBuildingType;

        private MeshObject taskTargetBuildMeshObject;
        private SceneNode taskTargetBuildSceneNode;

        //Player Faction
        private FactionType playerFaction;

        //Minimap
        private bool minimapChangeCameraPosition;

        private Control minimapControl;

        private float timeForUpdateGameStatus;

        private ScrollBar cameraDistanceScrollBar;
        private ScrollBar cameraHeightScrollBar;
        private bool disableUpdatingCameraScrollBars;
        ...
        private void DoTaskTargetChooseTasks(Vec3 mouseMapPos, Unit mouseOnObject)
        {
        ...
        private void DoRightClickTasks(Vec3 mouseMapPos, Unit mouseOnObject)
        {
            bool toQueue = EngineApp.Instance.IsKeyPressed(EKeys.Shift);
        ...
        private List<RTSUnitAI.UserControlPanelTask> GetControlTasks()
        {
        ...
        private void InitControlPanelButtons()
        {
            for (int n = 0; ; n++)
            {
        ...
        private void ControlPanelButton_Click(Button sender)
        {
        ...
        private void DrawHUD(GuiRenderer renderer)
        {
            if (selectMode && selectDraggedMouse)
            {
                Rect rect = new Rect(selectStartPos);
        ...
        private int TaskTargetChooseIndex
        {
        ...
        private Vec2 GetMapPositionByMouseOnMinimap()
        {
        ...
        private void UpdateHUDControlIcon()
        {
        ...
        private void UpdateCameraScrollBars()
        {
