...
namespace Game
{
    ...
    {
        private static GameEngineApp instance;

        //fading out functionality. Using for loading maps and for exit application.
        private const float fadingTime = 1;

        private float fadingOutTimer;

        //load map or world
        private string needMapLoadName;

        private bool needRunExampleOfProceduralMapCreation;
        private string needWorldLoadName;

        //application exit screen fading
        private bool needFadingOutAndExit;

        //fading in
        private float fadingInRemainingTime;

        private int fadingInSkipFirstFrames;

        //for network client
        private bool client_AllowCheckForDisconnection = true;

        private Control client_mapLoadingWindow;
        private bool client_SubscribedToMapLoadingEvents;

        private ScreenControlManager controlManager;
        ...
        private static bool showSystemCursor = true;
        ...
        private static MaterialSchemes materialScheme = MaterialSchemes.Default;
        ...
        private static ShadowTechniques shadowTechnique = ShadowTechniques.ShadowmapHigh;
        ...
        private static bool shadowUseMapSettings = true;
        ...
        private static ColorValue shadowColor = new ColorValue(.75f, .75f, .75f);
        ...
        private static float shadowFarDistance = 50;
        ...
        private static Vec2 shadowPSSMSplitFactors = new Vec2(.1f, .4f);
        ...
        private static int shadowDirectionalLightTextureSize = 2048;
        ...
        private static int shadowDirectionalLightMaxTextureCount = 1;
        ...
        private static int shadowSpotLightTextureSize = 2048;
        ...
        private static int shadowSpotLightMaxTextureCount = 2;
        ...
        private static int shadowPointLightTextureSize = 1024;
        ...
        private static int shadowPointLightMaxTextureCount = 2;
        ...
        private static WaterPlane.ReflectionLevels waterReflectionLevel = WaterPlane.ReflectionLevels.OnlyModels;
        ...
        private static bool showDecorativeObjects = true;
        ...
        private static float soundVolume = .8f;
        ...
        public List<ScreenMessage> screenMessages = new List<ScreenMessage>();
        ...
        private float loadingCallbackLastTimeCall;

        private void LongOperationCallbackManager_LoadingCallback(string callerInfo, object userData)
        {
        ...
        private string GetAutorunMapName()
        {
            string mapName = "";
        ...
        private bool IsScreenFadingOut()
        {
        ...
        protected override void OnTick(float delta)
        {
            ...
            if (GameMap.Instance != null)
                PhysicsWorld.Instance.MainScene.Gravity = new Vec3(0, 0, -GameMap.Instance.MapGravity);
        }
        ...
        private void SimulatePhysicsForLoadedMap(float seconds)
        {
        ...
        private GameWindow CreateGameWindowByGameType(GameMap.GameTypes gameType)
        {
            switch (gameType)
            {
                case GameMap.GameTypes.AssaultKnights:
                    return new AKGameWindow();
        ...
        private void Map_Client_MapLoadingBegin()
        {
            //Subcribe to callbacks during engine loading. We will render scene from callback.
        ...
        private void Map_Client_MapLoadingEnd()
        {
            if (client_mapLoadingWindow != null)
                LongOperationCallbackManager.Unsubscribe();
        }
        ...
        private static readonly string[] skipLogMessages = new string[]{
        ...
        private void InvisibleLog_Handlers_InfoHandler(string text, ref bool dumpToLogFile)
        {
        ...
        private void Log_Handlers_WarningHandler(string text, ref bool handled, ref bool dumpToLogFile)
        {
            if (EngineConsole.Instance != null)
            {
                handled = true;
        ...
        private void Log_Handlers_ErrorHandler(string text, ref bool handled, ref bool dumpToLogFile)
        {
            if (controlManager != null)
            {
                ...
                MessageBoxWindow messageBoxWindow = new MessageBoxWindow(text, "Error", "Error",
        ...
        private void Log_Handlers_FatalHandler(string text, string createdLogFilePath, ref bool handled)
        {
            if (controlManager != null)
            {
                //find already created MessageBoxWindow
        ...
        private void MakeScreenshot()
        {
            ...
            for (int n = 1; n < 1000; n++)
            {
                ...
                if (!File.Exists(fileName))
                {
                    ...
                    if (EngineConsole.Instance != null) //iNCIN
                        EngineConsole.Instance.Print("Screenshot: " + fileName);// iNCIN
                    break;
                }
            }
        }

        private static void ConsoleCommand_ShowProfilingTool(string arguments)
        {
            bool show = ProfilingToolWindow.Instance == null;
        ...
        private void ActivateScreenFadingIn()
        {
