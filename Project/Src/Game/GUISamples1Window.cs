...
namespace Game
{
    public class GUISamples1Window : Control
    {
        ...
        private ComboBox comboBoxDrawAreaMode;
        private Font drawAreaBigFont;
        private Font drawAreaSmallFont;

        ///////////////////////////////////////////

        private enum DrawAreaModes
        {
            Triangles,
            Quads,
            Lines,
        ...
        private bool IsCustomShaderModeEnabled()
        {
        ...
        private DrawAreaModes GetDrawAreaMode()
        {
        ...
        private void passwordEditBox_TextChange(Control sender)
        {
