...
namespace Game
{
    ...
    {
        private List<MapCameraCurve> cameraCurves;
        private float cameraCurvesTotalTime;

        private bool demoMode;
        private float demoModeTime;

        private float screenTextAlpha;
        private float lastTimeOfKeyDownOrMouseMove;
        private Vec2 screenTextLastMousePosition;
        ...
        private void AddTextWithShadow(GuiRenderer renderer, string text, Vec2 position,
        ...
        private void DrawScreenText(GuiRenderer renderer)
        {
