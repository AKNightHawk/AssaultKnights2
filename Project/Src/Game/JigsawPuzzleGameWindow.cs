...
namespace Game
{
    ...
    public class JigsawPuzzleGameWindow : GameWindow
    {
        ...
        //tryingToMovePiece
        private JigsawPuzzlePiece tryingToMovePiece;

        private Vec2 tryingToMovePieceOffset;

        private bool shouldSendMovingPiecePositionToServer;
        private Vec2 shouldSendMovingPiecePositionToServer_Position;
        private float shouldSendMovingPiecePositionToServer_LastSentTime;
        ...
        private void UpdateShouldSendMovingPiecePositionToServer(bool obligatoryToSend)
        {
