...
namespace Game
{
    ...
    public class MapsWindow : Control
    {
        ...
        private ListBox listBoxRecentlyLoaded;
        private Control window;
        private ComboBox comboBoxAutorunMap;
        ...
        private void UpdateMapPreviewImageAndDescription()
        {
            //find selected map
            string mapName = null;
        ...
        private void listBoxMaps_SelectedIndexChanged(object sender)
        {
            UpdateMapPreviewImageAndDescription();
        }

        private void listBoxRecentlyLoaded_SelectedIndexChanged(object sender)
        {
            UpdateMapPreviewImageAndDescription();
        ...
        private void UpdateRecentlyLoadedMapsList(string name)
        {
