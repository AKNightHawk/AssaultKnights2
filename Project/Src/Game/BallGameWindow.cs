...
namespace Game
{
    ...
    public class BallGameWindow : GameWindow
    {
        ...
        private SphereDir cameraDirection = new SphereDir(MathFunctions.PI / 2, -MathFunctions.PI / 4);
        ...
        private void TickUserForceToBall(float delta)
        {
        ...
        private void RecreateBallIfNeed()
        {
