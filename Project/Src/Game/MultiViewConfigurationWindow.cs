...
namespace Game
{
    ...
    {
        private static ViewConfigurations lastViewsConfiguration = ViewConfigurations.NoViews;
        private Control window;
        private ListBox listBoxViews;
        private CheckBox checkBoxShowMainScene;
        private ScrollBar scrollBarViewsOpacity;
        private CheckBox checkBoxDrawDebugInfo;
        ...
        private void listBoxViews_SelectedIndexChange(ListBox sender)
        {
        ...
        private void checkBoxShowMainScene_CheckedChange(CheckBox sender)
        {
        ...
        private void scrollBarViewsOpacity_ValueChange(ScrollBar sender)
        {
            if (MultiViewRenderingManager.Instance != null)
            {
        ...
        private void checkBoxDrawDebugInfo_CheckedChange(CheckBox sender)
        {
            if (MultiViewRenderingManager.Instance != null)
