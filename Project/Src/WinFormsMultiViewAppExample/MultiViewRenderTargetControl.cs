...
namespace WinFormsMultiViewAppExample
{
    public class MultiViewRenderTargetControl : Control
    {
        ...
        public class View
        {
            private MultiViewRenderTargetControl owner;
            private Rect rectangle;
            private RenderTargetUserControl control;
        ...
        private void Control_Tick(RenderTargetUserControl sender, float delta)
        {
            if (Tick != null)
                Tick(this, delta);
        }
        ...
        private void Control_Render(RenderTargetUserControl sender, Camera camera)
        {
            if (Render != null)
            {
        ...
        private void Control_RenderUI(RenderTargetUserControl sender, GuiRenderer renderer)
        {
            if (RenderUI != null)
            {
                int viewIndex = GetViewIndexByControl(sender);
