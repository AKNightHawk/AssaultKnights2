...
namespace WinFormsMultiViewAppExample
{
    ...
    {
        private static string lastOpenedNodeFullPath = "";

        ///////////////////////////////////////////

        private class ToolsLocalizedPropertyDescriptor : PropertyDescriptor, _IWrappedPropertyDescriptor
        {
            private object obj;
        ...
        private class ToolsLocalizedTypeDescriptor : CustomTypeDescriptor, _IWrappedCustomTypeDescriptor
        {
            private object obj;
            private string translateGroup;
        ...
        private bool OnIsAllowOKRecursive(TreeNode node)
        {
        ...
        private void OnOKRecursive(TreeNode node)
        {
            OptionsLeaf leaf = (OptionsLeaf)node.Tag;
            leaf.OnOK();
            foreach (TreeNode child in node.Nodes)
