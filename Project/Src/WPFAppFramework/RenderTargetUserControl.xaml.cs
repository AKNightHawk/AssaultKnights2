...
namespace WPFAppFramework
{
    ...
    {
        //camera settings
        private Range cameraNearFarClipDistance = new Range(.1f, 1000);

        private Vec3 cameraPosition;
        private Vec3 cameraFixedUp = Vec3.ZAxis;
        private Vec3 cameraDirection = Vec3.XAxis;
        private Degree cameraFov = 80;
        private ProjectionTypes cameraProjectionType = ProjectionTypes.Perspective;
        private float cameraOrthoWindowHeight = 100;
        ...
        private bool needCreateRenderTarget;
        private Vec2I currentTextureSize;
        private byte[] tempRenderTextureArray;

        //update render target
        private float automaticUpdateFPS = 30;

        private System.Windows.Forms.Timer updateTimer;
        private float lastRenderTime;

        //keys
        private Set<Key> keys = new Set<Key>();

        //MouseRelativeMode
        private bool mouseRelativeMode;

        private Vec2I mouseRelativeModeStartPosition;
        private bool mouseRelativeModeIgnoreFirst;

        private GuiRenderer guiRenderer;
        private ScreenControlManager controlManager;

        private ViewRenderTargetListener renderTargetListener;

        private bool allowUsingD3DImage;
        private bool d3dImageIsSupported;
        ...
        private class ViewRenderTargetListener : RenderTargetListener
        {
            private RenderTargetUserControl owner;
        ...
        private struct GetD3D9HardwarePixelBufferData
        {
        ...
        private Vec2I GetDemandTextureSize()
        {
        ...
        private bool IsActivateFXAAByDefault()
        {
        ...
        private void RenderScene(DrawingContext drawingContext)
        {
            if (WPFAppWorld.DuringWarningOrErrorMessageBox)
                return;
        ...
        private bool GetEKeyByKeyCode(Key keyCode, out EKeys eKey)
        {
        ...
        private EMouseButtons GetEMouseButtonByMouseButton(MouseButton button)
        {
        ...
        private Vec2I GetLocalMousePosition()
        {
