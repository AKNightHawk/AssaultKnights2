...
namespace ProjectCommon
{
    ...
    {
        private float maxLifeTimeNotUsedDataInCache;
        private bool showScene;
        private bool sceneUnderConstruction;

        private Dictionary<string, BlockImpl> blockCache = new Dictionary<string, BlockImpl>();
        private Set<BlockImpl> blocksWithoutCaching = new Set<BlockImpl>();

        //scene data
        private List<SceneItem> sceneItems = new List<SceneItem>();

        private int sceneItemsShrinkMaxLength;
        private int sceneItemsShrinkCounter;
        private SceneObject[] sceneObjectsArray;

        private static long uniqueMeshNameCounter;

        private MaterialManagerWithoutTexturesClass materialManagerWithoutTextures;
        private MaterialManagerWithTexturesClass materialManagerWithTextures;
        private long uniqueMaterialNameForMaterialsWithTextures;

        private static Vertex[] boxVertices;
        private static int[] boxIndices;

        ///////////////////////////////////////////

        private class BlockImpl : Block
        {
            private static CompileBatchComparer compileBatchComparer = new CompileBatchComparer();

            public DynamicMeshManagerImpl owner;
            private bool disposed;
            private List<InputItem> inputData = new List<InputItem>();
            ...
            {
                private BlockImpl owner;
                private Dictionary<int, List<SceneObject>> sceneObjectsByHash = new Dictionary<int, List<SceneObject>>();
            ...
            private class CompileBatchComparer : IEqualityComparer<InputItem>
            {
            ...
            private void AddTrianglesInternal(bool allowBatching, Vertex[] vertices, VertexComponents vertexComponents,
            ...
            private CompiledItem CompileInputItems(List<InputItem> inputItems)
            {
            ...
            private static unsafe Vertex[] GetVerticesFromVertexData(VertexData vertexData, out VertexComponents components)
            {
            ...
            private void DestroyCompiledData()
            {
        ...
        private class MaterialDataImpl : MaterialData
        {
            public DynamicMeshManagerImpl owner;
        ...
        private class SceneObject
        {
            ...
            private static void SetMeshObjectMaterial(DynamicMeshManagerImpl owner, MeshObject meshObject, MaterialDataImpl material,
        ...
        private class MaterialManagerWithoutTexturesClass
        {
            private DynamicMeshManagerImpl manager;
            private ShaderBaseMaterial[] realMaterials = new ShaderBaseMaterial[2048];
        ...
        private class MaterialManagerWithTexturesClass
        {
            private DynamicMeshManagerImpl manager;

            private Dictionary<MaterialParameters, ShaderBaseMaterial> realMaterials =
        ...
        private void DeleteLongTimeNotUsedBlocksFromCache()
        {
            float time = EngineApp.Instance.Time;
        ...
        private ShaderBaseMaterial CreateRealMaterial(MaterialParameters parameters, int indexForMaterialsWithoutTexture)
        {
            string materialName;
            if (!string.IsNullOrEmpty(parameters.DiffuseMap))
            {
