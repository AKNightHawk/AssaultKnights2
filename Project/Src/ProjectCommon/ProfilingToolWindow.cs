...
namespace ProjectCommon
{
    ...
    public class ProfilingToolWindow : Control
    {
        ...
        private void Background_CheckedChange(CheckBox sender)
        {
        ...
        private class FrameStatisticsPage : Page
        {
        ...
        private class RenderingSystemPage : Page
        {
            ...
            private void textureListButton_Click(Button sender)
            {
            ...
            private void meshListButton_Click(Button sender)
            {
        ...
        private class PhysicsSystemPage : Page
        {
            private long lastRayCasts = -1;
            private long lastVolumeCasts = 0;
            private long lastCreatedBodies = 0;
            private long lastPushedToWorldBodies = 0;
        ...
        private class SoundSystemPage : Page
        {
        ...
        private class EntitySystemPage : Page
        {
        ...
        private class MemoryManagementPage : Page
        {
        ...
        private class DLLPage : Page
        {
            ...
            private void ComboBox_SelectedIndexChange(ComboBox sender)
            {
                updated = false;
            }
        ...
        private class NetworkingPage : Page
        {
            ...
            private void GetConnectedNodeData(NetworkNode.ConnectedNode connectedNode, StringBuilder text)
            {
        ...
        private class InputDevicesPage : Page
        {
            private ColorValue disabledColor = new ColorValue(.15f, .15f, .35f);
            private ColorValue enabledColor = new ColorValue(1, 1, 1);
            private ColorValue pressedColor = new ColorValue(0, 1, 0);

            private JoystickInputDevice selectedJoystick;

            ////////////////////////////////////////

            private class TestEffectAxisItem
            {
            ...
            private void devicesComboBox_SelectedIndexChange(ComboBox sender)
            {
            ...
            private void UpdatePOVControls()
            {
            ...
            private void UpdateBarControlValue(Control control, float value)
            {
            ...
            private void UpdateSliderControls()
            {
                {
            ...
            private ForceFeedbackEffect GetSelectedEffect()
            {
            ...
            private void UpdateSelectedEffectInfo()
            {
                StringBuilder text = new StringBuilder();
            ...
            private void UpdateForceFeedbackControls()
            {
                UpdateEffectList();
            ...
            private void EffectDestroy_Click(Button sender)
            {
                ForceFeedbackEffect effect = GetSelectedEffect();
                if (effect != null)
                    effect.Destroy();
            ...
            private void TestEffectCreate_Click(Button sender)
            {
                if (selectedJoystick == null)
                    return;
                if (selectedJoystick.ForceFeedbackController == null)
        ...
        private class SettngsPage : Page
        {
            private List<CheckBox> checkBoxes = new List<CheckBox>();
            private bool disableChangeEvents;
            ...
            private void Defaults_Click(Button sender)
            {
            ...
            private void InitCheckBox(string name, PropertyInfo property)
            {
            ...
            private void checkBox_CheckedChange(CheckBox sender)
            {
        ...
        private class TimePage : Page
        {
            private static bool independentParameters;
            private CheckBox independentParametersCheckBox;
            private ScrollBar engineTimeScaleScrollBar;
            private ScrollBar soundPitchScaleScrollBar;
            private bool disableChangeEvents;
            ...
            private void independentParametersCheckBox_CheckedChange(CheckBox sender)
            {
            ...
            private void engineTimeScaleScrollBar_ValueChange(ScrollBar sender)
            {
                if (!disableChangeEvents)
                {
            ...
            private void soundPitchScaleScrollBar_ValueChange(ScrollBar sender)
            {
                if (!disableChangeEvents)
                {
                    float value = float.Parse(sender.Value.ToString("F1"));
        ...
        private class FullScreenEffectsPage : Page
        {
            private Viewport viewport;

            private ListBox listBoxAvailable;
            private ListBox listBoxEnabled;

            private CheckBox checkBoxManualControl;
            private CheckBox checkBoxEnabled;
            private ScrollBar[] scrollBarFloatParameters = new ScrollBar[11];
            private CheckBox[] checkBoxBoolParameters = new CheckBox[11];

            private bool disableChangeEvents;

            private static bool manualControl;
            private static string lastSelectedEffect = "";
            ...
            private static int GetCompositorPriority(string compositorName)
            {
            ...
            private string GetListCompositorItemName(string itemName)
            {
                return itemName.Split(new char[] { ' ' })[0];
            }

            private void checkBoxManualControl_Click(CheckBox sender)
            {
                manualControl = checkBoxManualControl.Checked;
                MapCompositorManager.PreventCompositorInstancesUpdate = manualControl;
            }

            private void listBox_SelectedIndexChange(ListBox sender)
            {
                if (!disableChangeEvents)
                {
                    disableChangeEvents = true;
            ...
            private void listBoxCheckBox_Click(CheckBox sender)
            {
            ...
            private void applyToTheScreenGUICheckBox_Click(CheckBox sender)
            {
                EngineApp.Instance.ScreenGuiRenderer.ApplyPostEffectsToScreenRenderer = sender.Checked;
            }

            private void checkBoxEnabled_Click(CheckBox sender)
            {
                if (listBoxAvailable.SelectedItem != null)
                {
            ...
            private void floatParameter_ValueChange(ScrollBar sender)
            {
            ...
            private void boolParameter_CheckedChange(CheckBox sender)
            {
                if (!disableChangeEvents)
                    UpdateCurrentEffect(true);
            }
            ...
            private void UpdateListBoxEnabled()
            {
            ...
            private void UpdateApplyToTheScreenGUICheckBox()
            {
                CheckBox checkBox = (CheckBox)PageControl.Controls["ApplyToTheScreenGUI"];
                checkBox.Checked = EngineApp.Instance.ScreenGuiRenderer.ApplyPostEffectsToScreenRenderer;
            }

            private List<PropertyInfo> GetCompositorInstanceProperties(Type type)
            {
            ...
            private void UpdateCurrentEffectControls()
            {
            ...
            private void UpdateCurrentEffect(bool updateParameters)
            {
                string name = GetListCompositorItemName(listBoxAvailable.SelectedItem.ToString());
        ...
        private class FileSystemPage : Page
        {
            ...
            private void buttonClear_Click(Button sender)
            {
            ...
            private void Log_Handlers_InfoHandler(string text, ref bool dumpToLogFile)
            {
        ...
        private class ProjectSpecificPage : Page
        {
