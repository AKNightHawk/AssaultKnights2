...
namespace ProjectCommon
{
    ...
    {
        private static List<VegetationMaterial> allVegetationMaterials = new List<VegetationMaterial>();

        //

        private bool receiveObjectsPositionsFromVertices;

        private float windEffectFactor = 1f;

        private float bendScale = 0.02f;
        private float bendVariation = 0.005f;
        private float bendFrequency = 1f;

        private bool detailBending = false;
        private float branchAmplitude = 0.01f;
        private float leafAmplitude = 0.01f;
        private float branchFrequency = 1f;
        private float leafFrequency = 1f;

        private Vec2 windSpeed = new Vec2(1, 0); //so we can see it in Resource Editor
        ...
        private void UpdateWindAnimationParameters()
        {
        ...
        private void UpdateMainBendingParameters()
        {
        ...
        private void UpdateDetailBendingParameters()
        {
        ...
        private void SetCustomGpuParameter(VegetationGpuParameters parameter, Vec4 value)
        {
