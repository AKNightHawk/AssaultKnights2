...
namespace ProjectCommon
{
    ...
    {
        private static MultiViewRenderingManager instance;

        private List<View> views = new List<View>();
        private ReadOnlyCollection<View> viewsReadOnly;
        private bool mainCameraDraw3DScene;
        private bool drawDebugInfo;

        private int preventTextureCreationRemainingFrames;
        ...
        public class View
        {
            ...
            private Vec2I initializedTextureSize;
            ...
            private Vec2I GetNeededTextureSize()
            {
        ...
        private MultiViewRenderingManager()
        {
