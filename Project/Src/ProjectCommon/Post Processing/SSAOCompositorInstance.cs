...
namespace ProjectCommon
{
    ...
    public class SSAOCompositorParameters : CompositorParameters
    {
        ...
        private float downsampling = 1;

        //int iterations = 24;
        private float sampleLength = 2;

        private float offsetScale = .1f;
        private float defaultAccessibility = .6f;
        private float maxDistance = 50;
        private float blurSpread = 1;
    ...
    public class SSAOCompositorInstance : CompositorInstance
    {
        ...
        private float offsetScale = .05f;
        private float defaultAccessibility = .7f;
        private float maxDistance = 50;
        private float blurSpread = 1;
