...
namespace ProjectCommon
{
    ...
    {
        private float focalDistance = 30;
        private bool autoFocus = true;
        private float focalSize = 20;
        private float blurSpread = .3f;
        private float blurTextureResolution = 5;
        private float backgroundTransitionLength = 40;
        private bool blurForeground = true;
        private float foregroundTransitionLength = 40;
        private Range autoFocusRange = new Range(1, 70);
        private float autoFocusTransitionSpeed = 100;
    ...
    public class DepthOfFieldCompositorInstance : CompositorInstance
    {
        ...
        private Vec2I downscaleTextureSize;
        ...
        private static void CalculateBlurSampleOffsets(int textureSize, float[] sampleOffsets,
