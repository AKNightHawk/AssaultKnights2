...
namespace ProjectCommon
{
    ...
    {
        private bool adaptation;
        private float adaptationVelocity = 1;
        private float adaptationMiddleBrightness = .5f;
        private float adaptationMinimum = .2f;
        private float adaptationMaximum = 2;
        private float bloomBrightThreshold = 1.2f;
        private float bloomScale = 1.25f;
    ...
    public class HDRCompositorInstance : CompositorInstance
    {
        ...
        private float lastLuminanceCalculationTime = -1;
        private Vec2I brightPassTextureSize;
        private Vec2I bloomTextureSize;
        ...
        private static void CalculateGaussianBlur5x5SampleOffsets(Vec2I textureSize,
        ...
        private static void CalculateBloomSampleOffsets(int textureSize, float[] sampleOffsets,
        ...
        private void RenderSystemEvent(RenderSystemEvents name)
        {
