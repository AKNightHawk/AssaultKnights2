...
namespace ProjectCommon
{
    ...
    {
        private const float shadowMapFarClipDistance = 2000;
        private const float directionalLightExtrusionDistance = 1000;

        private RenderLight[] tempLightArray = new RenderLight[0];

        //clip volumes for occlusion culling
        private static Stack<Box[]> clipVolumes = new Stack<Box[]>();

        private static Box[] totalClipVolumes = new Box[0];
        ...
        private void GetDirectionalLightCameraCornerPoints(Camera mainCamera, float initialNearDistance,
        ...
        private Vec3 GetDirectionalLightCameraDestinationPoint(Camera mainCamera, Vec3[] cornerPoints)
        {
        ...
        private ConvexPolyhedron GetConvexPolyhedronFromFrustum(ref Frustum frustum)
        {
        ...
        private static Plane[] GetClipPlanesOfConvexHullAroundMainCameraAndLightPosition(
        ...
        private static void WalkSpotLightShadowGeneration(Camera mainCamera, RenderLight light,
        ...
        private static Plane[] GetClipPlanesForPointLightShadowGeneration(Camera mainCamera,
        ...
        private static void WalkPointLightShadowGeneration(Camera mainCamera, RenderLight light,
        ...
        private static Plane[] GetClipPlanesForDirectionalLightShadowGeneration(Camera mainCamera,
        ...
        private static void WalkDirectionalLightShadowGeneration(Camera mainCamera, RenderLight light,
        ...
        private static void WalkAll(List<SceneNode> outSceneNodes, List<StaticMeshObject> outStaticMeshObjects, List<RenderLight> outLights)
        {
            //add directional lights
            if (outLights != null)
            {
        ...
        private void GetShadowCastersForLight(Camera mainCamera, RenderLight light, int directionalLightPSSMTextureIndex,
        ...
        private void GetObjectsForUsualCamera(Camera camera, List<SceneNode> outSceneNodes, List<StaticMeshObject> outStaticMeshObjects,
        ...
        private static bool IsIntersects(RenderLight light, Bounds bounds)
        {
            if (light.Type == RenderLightType.Point || light.Type == RenderLightType.Spot)
            {
        ...
        private static void UpdateTotalClipVolumes()
        {
        ...
        private static bool IsTotalClipVolumesContainsBounds(Bounds bounds)
        {
        ...
        private static int[] GetOverrideVisibleObjectsSceneGraphIndexes()
        {
