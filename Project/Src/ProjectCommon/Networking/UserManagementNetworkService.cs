...
namespace ProjectCommon
{
    ...
    {
        private Dictionary<uint, UserInfo> usersByIdentifier = new Dictionary<uint, UserInfo>();

        private Dictionary<NetworkNode.ConnectedNode, UserInfo> usersByConnectedNode =
            new Dictionary<NetworkNode.ConnectedNode, UserInfo>();

        private UserInfo serverUser;
        ...
        public class UserInfo
        {
            ...
            private uint defaultSpawnPoint;

            public uint DefaultSpawnPoint
            {
            ...
            private string name;
            private NetworkNode.ConnectedNode connectedNode;
        ...
        private uint GetFreeUserIdentifier()
        {
            uint identifier = 1;
    ...
    {
        //key: user identifier
        private Dictionary<uint, UserInfo> users = new Dictionary<uint, UserInfo>();
        ...
        private void AddUser(uint identifier, string name, bool thisUserFlag)
        {
