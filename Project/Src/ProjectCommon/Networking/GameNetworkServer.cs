...
namespace ProjectCommon
{
    public class GameNetworkServer : NetworkServer
    {
        ...
        private bool allowToConnectNewClients = true;

        //services
        private UserManagementServerNetworkService userManagementService;

        private CustomMessagesServerNetworkService customMessagesService;
        private ChatServerNetworkService chatService;
        private EntitySystemServerNetworkService entitySystemService;

        private List<ConnectedNode> connectingNodes = new List<ConnectedNode>();
