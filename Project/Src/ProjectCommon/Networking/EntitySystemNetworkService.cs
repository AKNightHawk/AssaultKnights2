...
namespace ProjectCommon
{
    ...
    {
        private MessageType[] entitySystemInternalMessageTypes = new MessageType[6];

        private UserManagementServerNetworkService userManagementService;
        private ServerEntitySystemNetworkingInterface networkingInterface;
        private List<ClientRemoteEntityWorld> clientRemoteEntityWorlds = new List<ClientRemoteEntityWorld>();

        private int worldCheckIdentifier;
        ...
        public class ClientRemoteEntityWorld : RemoteEntityWorld
        {
            ...
            private int receivedWorldIdentifier;
        ...
        private class ServerEntitySystemNetworkingInterface : EntitySystemWorld.NetworkingInterface
        {
            private EntitySystemServerNetworkService service;

            private List<NetworkNode.ConnectedNode> tempConnectedNodesList =
        ...
        private ClientRemoteEntityWorld GetRemoteEntityWorld(NetworkNode.ConnectedNode connectedNode)
        {
            for (int n = 0; n < clientRemoteEntityWorlds.Count; n++)
            {
                ClientRemoteEntityWorld remoteEntityWorld = clientRemoteEntityWorlds[n];
    ...
    public class EntitySystemClientNetworkService : ClientNetworkService
    {
        ...
        private ClientEntitySystemNetworkingInterface networkingInterface;
        private RemoteEntityWorld serverRemoteEntityWorld;
        ...
        private class ClientEntitySystemNetworkingInterface : EntitySystemWorld.NetworkingInterface
        {
            private EntitySystemClientNetworkService service;
        ...
        private bool ReceiveMessage_WorldCreateEndToClient(NetworkNode.ConnectedNode sender,
            MessageType messageType, ReceiveDataReader reader, ref string additionalErrorMessage)
        {
            if (!reader.Complete())
                return false;
