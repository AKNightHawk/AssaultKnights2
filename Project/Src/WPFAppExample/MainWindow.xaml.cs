...
namespace WPFAppExample
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void renderTargetUserControl1_MouseDown(object sender, MouseButtonEventArgs e)
        {
        ...
        private void renderTargetUserControl1_MouseUp(object sender, MouseButtonEventArgs e)
        {
            //free camera rotating
        ...
        private void RenderEntityOverCursor(Camera camera)
        {
        ...
        private void RestartApplication(bool d3dImageSupport)
        {
            try
            {
