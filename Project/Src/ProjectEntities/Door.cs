...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private Vec3 openDoorBodyOffset = new Vec3(0, 0, 1);

        [FieldSerialize]
        private Vec3 openDoor2BodyOffset = new Vec3(0, 0, 1);
    ...
    public class Door : Dynamic
    {
        ...
        [FieldSerialize]
        private float openDoorOffsetCoefficient;
        ...
        private DoorType _type = null; public new DoorType Type { get { return _type; } }
        ...
        private void Server_SendOpenSettingsToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Server_SendSoundOpenToAllClients()
        {
        ...
        private void Client_ReceiveSoundOpen(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
            if (!reader.Complete())
                return;
            SoundPlay3D(Type.SoundOpen, .5f, false);
        ...
        private void Server_SendSoundCloseToAllClients()
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(Door),
        ...
        private void Client_ReceiveSoundClose(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
            if (!reader.Complete())
                return;
            SoundPlay3D(Type.SoundClose, .5f, false);
