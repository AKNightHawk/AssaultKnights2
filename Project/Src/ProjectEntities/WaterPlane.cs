...
namespace ProjectEntities
{
    public class WaterPlaneType : MapGeneralObjectType
    {
        ...
        private float physicsDensity = 1000;

        [FieldSerialize("splashes")]
        private List<SplashItem> splashes = new List<SplashItem>();
        ...
        public class SplashItem
        {
            ...
            private SplashTypes splashType;
    ...
    {
        private WaterPlane owner;
        private TextureUnitState reflectionMapState;
        ...
        private static void SetProgramAutoConstants(GpuProgramParameters parameters)
        {
            //Matrix
        ...
        private void CreateDefaultTechnique()
        {
        ...
        private void SceneManager_FogAndShadowSettingsChanged(bool fogModeChanged, bool shadowTechniqueChanged)
        {
        ...
        private void SetGpuNamedConstant(string name, Vec4 value)
        {
    ...
    {
        private static List<WaterPlane> instances = new List<WaterPlane>();

        [FieldSerialize("size")]
        private Vec2 size = new Vec2(1000, 1000);

        [FieldSerialize("position")]
        private Vec3 position;

        [FieldSerialize("segments")]
        private Vec2I segments = new Vec2I(20, 20);

        [FieldSerialize("customMesh")]
        private string customMesh = "";

        [FieldSerialize("renderQueueGroup")]
        private RenderQueueGroups renderQueueGroup = RenderQueueGroups.Queue3;

        [FieldSerialize("reflectionLevel")]
        private ReflectionLevels reflectionLevel = ReflectionLevels.OnlyModels;

        [FieldSerialize("physicsHeight")]
        private float physicsHeight;

        [FieldSerialize("deepColor")]
        private ColorValue deepColor = new ColorValue(0, .3f, .5f);

        [FieldSerialize("shallowColor")]
        private ColorValue shallowColor = new ColorValue(0, 1, 1);

        [FieldSerialize("reflectionColor")]
        private ColorValue reflectionColor = new ColorValue(1, 1, 1);

        [FieldSerialize("reflectionTextureSize")]
        private ReflectionTextureSizes reflectionTextureSize = ReflectionTextureSizes.HalfOfFrameBuffer;

        [FieldSerialize("visible")]
        private bool visible = true;

        [FieldSerialize("fixedPipelineMap")]
        private string fixedPipelineMap = "Base\\Types\\Water Plane\\WaterFixedPipeline.jpg";

        [FieldSerialize("fixedPipelineMapTiling")]
        private float fixedPipelineMapTiling = 10;

        [FieldSerialize("fixedPipelineColor")]
        private ColorValue fixedPipelineColor = new ColorValue(0, .3f, .5f);

        [FieldSerialize("useHDRTexture")]
        private bool useHDRTexture;

        [FieldSerialize("allowFog")]
        private bool allowFog = true;

        private bool needUpdatePlane = true;
        private Mesh meshPlane;
        private MeshObject meshObject;
        private SceneNode sceneNode;

        private WaterPlaneHighLevelMaterial material;

        private List<ReflectionTextureItem> reflectionTextureItems = new List<ReflectionTextureItem>();

        //Key: splash type, Value: available items for this alias
        private Dictionary<WaterPlaneType.SplashTypes, WaterPlaneType.SplashItem[]> splashItemsCache;

        private List<SplashOffItem> bodiesSplashOffTime = new List<SplashOffItem>();

        private bool server_shouldSendPropertiesToClients;
        ...
        private struct SubmergedCheckItem
        {
            public float coef;
            public Vec3 center;
        ...
        private class ReflectionTextureItem
        {
        ...
        private WaterPlaneType _type = null; public new WaterPlaneType Type { get { return _type; } }
        ...
        private void UpdateBodiesSplashOffTime()
        {
        ...
        private ReflectionTextureItem GetReflectionTextureItemByViewport(Viewport viewport)
        {
        ...
        private static List<Camera> FindAllMainCameras()
        {
        ...
        private void DeleteUnusedReflectionTextureItems()
        {
        ...
        private Vec2I GetRequiredReflectionTextureSize(Viewport viewport)
        {
        ...
        private ReflectionTextureItem CreateReflectionTextureItem(Viewport viewport)
        {
        ...
        private void DestroyReflectionTextureItem(ReflectionTextureItem item)
        {
        ...
        private void RendererWorld_BeginRenderFrame()
        {
            DeleteUnusedReflectionTextureItems();
        }

        private void ViewportPreUpdate(Viewport viewport)
        {
        ...
        private void RenderSystem_RenderTargetPreUpdate(RenderTarget renderTarget)
        {
        ...
        private SubmergedCheckItem GetSphereSubmergedCoef(Sphere sphere)
        {
        ...
        private float GetShapeInfluenceDensity(Shape shape)
        {
        ...
        private void GetShapeSubmergedSpheres(ref Mat3 bodyRotation, Shape shape,
        ...
        private void CreateSplashes(Body body, List<SubmergedCheckItem> submergedItems)
        {
        ...
        private WaterPlaneType.SplashItem[] GetSplashItemsByType(WaterPlaneType.SplashTypes splashType)
        {
        ...
        private void RenderSystem_RenderSystemEvent(RenderSystemEvents name)
        {
        ...
        private void Server_SendPropertiesToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceivePropertiesToClient(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void Server_SendCreateSplashToAllClients(WaterPlaneType.SplashTypes splashType, Vec3 pos)
        {
        ...
        private void Client_ReceiveCreateSplash(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
