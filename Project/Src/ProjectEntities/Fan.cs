...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private float forceMaximum = 3500;

        [FieldSerialize]
        private Vec3 influenceRegionScale = new Vec3(20, 3, 3);

        [FieldSerialize]
        private float throttle = 1;

        private InfluenceRegion region;

        private GearedMotor bladesMotor;

        private float server_sentVelocityCoefficient;
        private float client_velocityCoefficient;
        ...
        private FanType _type = null; public new FanType Type { get { return _type; } }
        ...
        private void UpdateAttachedParticleSystem()
        {
        ...
        private float CalculateVelocityCoefficient()
        {
            if (bladesMotor == null)
                return 0;
        ...
        private void Server_TickSendVelocityCoefficientToAllClients()
        {
            float velocityCoefficient = CalculateVelocityCoefficient();
        ...
        private void Server_SendVelocityCoefficientToClients(IList<RemoteEntityWorld> remoteEntityWorlds,
            float value)
        {
        ...
        private void Client_ReceiveVelocityCoefficient(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
