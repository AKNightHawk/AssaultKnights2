...
namespace ProjectEntities
{
    ...
    public class ExplosionType : MapObjectType
    {
        ...
        [FieldSerialize]
        private bool ignoreReasonObject;

        [FieldSerialize]
        private InfluenceType influenceType;

        [FieldSerialize]
        private float influenceMaxTime;
    ...
    public class Explosion : MapObject
    {
        ...
        private static ListAllocator<MapObject> mapObjectListAllocator = new ListAllocator<MapObject>();

        private static ListAllocator<DamageItem> damageItemListAllocator = new ListAllocator<DamageItem>();
        ...
        private ExplosionType _type = null; public new ExplosionType Type { get { return _type; } }
        ...
        private void CreateWaterPlaneSplash()
        {
