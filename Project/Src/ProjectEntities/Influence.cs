...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private string defaultParticleName;

        [FieldSerialize]
        private Substance allowSubstance;
    ...
    public class Influence : Entity
    {
        ...
        private MapObjectAttachedParticle defaultAttachedParticle;
        ...
        private InfluenceType _type = null; public new InfluenceType Type { get { return _type; } }
        ...
        private void Server_SendRemainingTimeToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
