...
namespace ProjectEntities
{
    ...
    public class GameMap : Map
    {
        ...
        private GameTypes gameType = GameTypes.Action;

        [FieldSerialize]
        private string gameMusic = "Sounds\\Music\\Game.ogg";

        [FieldSerialize]
        private float Mapgravity = 10f;

        public float MapGravity
        {
            get { return Mapgravity; }
            set { Mapgravity = value; }
        }

        [FieldSerialize]
        private float Maptemp = 25f;
        ...
        [FieldSerialize]
        private float hangarUseRadius = 200;

        public float HangarUseRadius
        {
            get { return hangarUseRadius; }
            set { hangarUseRadius = value; }
        }

        //Wind settings
        [FieldSerialize]
        private Radian windDirection;

        [FieldSerialize]
        private float windSpeed = 1;

        [FieldSerialize]
        private UnitType playerUnitType;

        [FieldSerialize]
        private bool resetYCoordinateForDynamicBodies;

        [FieldSerialize]
        private float destroyObjectsBelowHeight = -500;
        ...
        private GameMapType _type = null; public new GameMapType Type { get { return _type; } }
        ...
        private void Server_SendGameTypeToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceiveGameType(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void UpdateWindSpeedSettings()
        {
            Vec2 speed = new Vec2(
        ...
        private void DoResetYCoordinateForDynamicBodies()
        {
        ...
        private void MainPhysicsScene_PostStep(PhysicsScene scene)
        {
