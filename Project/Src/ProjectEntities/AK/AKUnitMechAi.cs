    ...
    public class MechUnitAI : AI
    {
        ...
        public class MoveTask : Task
        {
            ...
            protected override void OnTick()
            {
                ...
                Mech controlledObj = Owner.ControlledObject;
        ...
        private Task CreateTaskByClassName(string className)
        {
            ...
            Log.Fatal("MechUnitAI: CreateTaskByClassName: Unknown task class name {0}.", className);
            return null;
        }
        ...
        private string GetTaskClassName(Task task)
        {
            ...
            Log.Fatal("MechUnitAI: GetTaskClassName: Unknown task class.");
            return "";
        }
        ...
        [Browsable(false)]
        public new Mech ControlledObject
        {
            get { return (Mech)base.ControlledObject; }
        }
