...
namespace ProjectEntities
{
    ...
    public class InfluenceRegion : Region
    {
        [FieldSerialize]
        [DefaultValue(0.0f)]
        private float impulsePerSecond;
        ...
        private DistanceFunctionType distanceFunction;

        [FieldSerialize]
        [DefaultValue(0.0f)]
        private float force;

        private InfluenceRegionType _type = null; public new InfluenceRegionType Type { get { return _type; } }
        ...
        private float GetDistanceCoefficient(Vec3 pos)
        {
