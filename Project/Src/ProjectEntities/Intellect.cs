...
namespace ProjectEntities
{
    ...
    public abstract class Intellect : Entity
    {
        ...
        private IntellectType _type = null; public new IntellectType Type { get { return _type; } }
        ...
        private void Server_SendControlledObjectToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceiveControlledObject(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
