...
namespace ProjectEntities
{
    ...
    public class PhysicalStreamType : DynamicType
    {
        ...
        public class Mode
        {
            ...
            [FieldSerialize]
            [DefaultValue(0.0f)]
            private float influenceTimePerSecond;
    ...
    public class PhysicalStream : Dynamic
    {
        ...
        private PhysicalStreamType _type = null; public new PhysicalStreamType Type { get { return _type; } }

        private MapObjectAttachedParticle modeAttachedParticle;
        ...
        private void Server_SendThrottleToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceiveThrottle(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void Server_SendAlternativeModeToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds, typeof(PhysicalStream),
