...
namespace ProjectEntities
{
    ...
    public class FloatSwitch : Switch
    {
        ...
        private bool use;
        private bool useChangeIncrease;

        private FloatSwitchType _type = null; public new FloatSwitchType Type { get { return _type; } }
        ...
        private void Server_ReceiveUseStart(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
