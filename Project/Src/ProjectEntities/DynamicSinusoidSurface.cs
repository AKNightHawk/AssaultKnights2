...
namespace ProjectEntities
{
    ...
    {
        private const int tesselation = 30;

        private Mesh mesh;
        private MapObjectAttachedMesh attachedMesh;

        private bool needRecreateMesh;
        private bool needUpdateGeometry;
        ...
        private DynamicSinusoidSurfaceType _type = null; public new DynamicSinusoidSurfaceType Type { get { return _type; } }
        ...
        private void AttachMeshToEntity()
        {
        ...
        private void DetachMeshFromEntity()
        {
