...
namespace ProjectEntities
{
    ...
    public class DecalCreatorType : MapObjectType
    {
        ...
        [FieldSerialize]
        private float omniMaxDistance = 1;
        ...
        [FieldSerialize]
        private float depthRenderOffset = .01f;

        [FieldSerialize]
        private float fadeTime;

        [FieldSerialize]
        private bool applyToMapObjects;
        ...
        {
            [FieldSerialize]
            private string physicsMaterialName = "";
        ...
        private LinkedList<Decal> createdDecals = new LinkedList<Decal>();

        private float checkMaxCountTime;
    ...
    public class DecalCreator : MapObject
    {
        ...
        private struct ShapeTriangleID : IEquatable<ShapeTriangleID>
        {
            public Shape shape;
        ...
        private DecalCreatorType _type = null; public new DecalCreatorType Type { get { return _type; } }
        ...
        private List<Vec3> CutConvexPlanePolygonByPlane(List<Vec3> vertices, Plane plane)
        {
        ...
        //optimization
        private static Set<ShapeTriangleID> triangleIDs = new Set<ShapeTriangleID>();

        private static Set<ShapeTriangleID> checkedTriangles = new Set<ShapeTriangleID>();
        private static Stack<ShapeTriangleID> trianglesForCheck = new Stack<ShapeTriangleID>(32);
        private static List<Decal.Vertex> tempVertices = new List<Decal.Vertex>(64);
        private static List<int> tempIndices = new List<int>(128);
