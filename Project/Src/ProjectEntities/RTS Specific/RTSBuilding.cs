...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private RTSUnitType productUnitType;

        [FieldSerialize]
        [DefaultValue(0.0f)]
        private float productUnitProgress;

        private MapObjectAttachedMesh productUnitAttachedMesh;

        [DefaultValue(1.0f)]
        [FieldSerialize]
        private float buildedProgress = 1;

        //

        private RTSBuildingType _type = null; public new RTSBuildingType Type { get { return _type; } }
        ...
        private void CreateProductUnitAttachedMesh()
        {
        ...
        private void DestroyProductUnitAttachedMesh()
        {
            if (productUnitAttachedMesh != null)
            {
        ...
        private void UpdateAttachedObjectsVisibility()
        {
