...
namespace ProjectEntities
{
    ...
    public class RTSUnitAI : AI
    {
        ...
        private float inactiveFindTaskTimer;

        [FieldSerialize]
        private Task currentTask = new Task(Task.Types.Stop);
        ...
        public struct Task
        {
            ...
            [FieldSerialize]
            private DynamicType entityType;
        ...
        private RTSUnitAIType _type = null; public new RTSUnitAIType Type { get { return _type; } }
        ...
        private void UpdateInitialWeapons()
        {
            RTSUnit controlledObj = ControlledObject;
