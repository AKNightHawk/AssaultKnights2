...
namespace ProjectEntities
{
    ...
    public class RTSCharacterType : RTSUnitType
    {
        ...
        private const float maxVelocityDefault = 5;

        [FieldSerialize]
        private float maxVelocity = maxVelocityDefault;
    ...
    public class RTSCharacter : RTSUnit, GridBasedNavigationSystem.IOverrideObjectBehavior
    {
        ...
        private Vec2 pathFoundedToPosition = new Vec2(float.NaN, float.NaN);
        ...
        private Vec3 oldMainBodyPosition;
        private Vec3 mainBodyVelocity;

        //

        private RTSCharacterType _type = null; public new RTSCharacterType Type { get { return _type; } }
