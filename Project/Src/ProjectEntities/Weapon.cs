...
namespace ProjectEntities
{
    ...
    public abstract class WeaponType : DynamicType
    {
        ...
        [FieldSerialize]
        private string characterBoneSlot = "";

        [FieldSerialize]
        private string characterBoneSlotFirstPersonCamera = "";

        [FieldSerialize]
        private Vec3 fpsCameraAttachPosition;
        ...
        public abstract class WeaponMode
        {
            [FieldSerialize]
            [DefaultValue(0.0f)]
            private float betweenFireTime = 0;
            ...
            private Vec3 startOffsetPosition;

            [FieldSerialize]
            [DefaultValue(typeof(Quat), "0 0 0")]
            private Quat startOffsetRotation = Quat.Identity;

            [FieldSerialize]
            [DefaultValue(typeof(Vec2), "0 0")]
            private Range useDistanceRange;

            [FieldSerialize]
            private List<float> fireTimes = new List<float>();

            [FieldSerialize]
            private string fireAnimationTrigger = "fire";
    ...
    {
        private MapObjectAttachedMesh mainMeshObject;

        private bool setForceFireRotation;
        private Quat forceFireRotation;

        //

        private WeaponType _type = null; public new WeaponType Type { get { return _type; } }
