...
namespace ProjectEntities
{
    ...
    public class GunType : WeaponType
    {
        ...
        public class GunMode : WeaponMode
        {
            ...
            [FieldSerialize]
            private int AkGunHeatGeneration = 75;

            [DefaultValue(75)]
            public int AKGunHeatGeneration
            {
                get { return AkGunHeatGeneration; }
                set { AkGunHeatGeneration = value; }
            }
            ...
            private Degree dispersionAngle;

            private MapObjectCreateObjectCollection fireObjects = new MapObjectCreateObjectCollection();
        ...
        [FieldSerialize]
        private GunMode normalMode = new GunMode();

        [FieldSerialize]
        private GunMode alternativeMode = new GunMode();
    ...
    public class Gun : Weapon
    {
        ...
        private bool destroyedSoundPlayed;

        public bool DestroyedSoundPlayed
        {
            get { return destroyedSoundPlayed; }
            set { destroyedSoundPlayed = value; }
        }

        [FieldSerialize]
        private Mode normalMode = new Mode();

        [FieldSerialize]
        private Mode alternativeMode = new Mode();
        ...
        private Mode currentFireMode;

        [FieldSerialize]
        private int fireTimesExecuted;

        private bool server_shouldSendBulletCountToClients;
        ...
        public class Mode
        {
            ...
            [FieldSerialize]
            private int bulletMagazineCount;
        ...
        private GunType _type = null; public new GunType Type { get { return _type; } }
        ...
        protected override void OnPostCreate(bool loaded)
        {
            ...
            if (!EntitySystemWorld.Instance.IsEditor())
                readyTime = resetTime = normalMode.typeMode.BetweenFireTime;
        ...
        protected override void OnTick()
        {
                ...
                again:
                    if (fireTimesExecuted < fireTimesCount)
                    {
                        ...
                        if (currentFireTime >= nextTime)
                        {
                            ...
                            currentFireMode.typeMode.FireObjects.CreateObjectsOfOneRandomSelectedGroup(this); //Incin Look At
            ...
            if (EntitySystemWorld.Instance.IsServer() &&
                Type.NetworkType == EntityNetworkTypes.Synchronized)
            {
                if (Server_damaged != damaged)
                {
                    Server_SendAKgunUpdatesToClients(
        ...
        public void TryReload()
        {
            if (Type.NormalMode.MagazineCapacity != 0 && normalMode.BulletCount != 0)
            {
                ...
                {
                    if (!needReload && EntitySystemWorld.Instance.IsServer())
                        Server_SendNeedReloadToClient(EntitySystemWorld.Instance.RemoteEntityWorlds);
        ...
        private void Server_SendUpdateBulletCountToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceiveUpdateBulletCount(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void Server_SendCreateBulletEventToAllClients(Mode mode)
        {
        ...
        private void Client_ReceiveCreateBulletEvent(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void Server_SendReloadEventToAllClients()
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(Gun),
        ...
        private void Client_ReceiveReloadEvent(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
            if (!reader.Complete())
                return;
            OnReload();
        ...
        private void Server_SendNoAmmoEventToAllClients()
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(Gun),
        ...
        private void Client_ReceiveNoAmmoEvent(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
            if (!reader.Complete())
                return;
        ...
        private void Server_SendFireEventToAllClients(bool alternative)
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(Gun),
        ...
        private void Client_ReceiveFireEvent(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private bool Server_damaged;

        private void Server_SendAKgunUpdatesToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds, typeof(Gun),
                (ushort)NetworkMessages.AKgunUpdates);

            writer.Write(damaged);

            EndNetworkMessage();
            Server_damaged = damaged;
        }

        [NetworkReceive(NetworkDirections.ToClient, (ushort)NetworkMessages.AKgunUpdates)]
        ...
        // bool server_ready;
        // public bool GUI_ready;
        /* void Server_SendUpdateGunReady(IList<RemoteEntityWorld> remoteEntityWorlds)
         {
             if (this.Ready != server_ready)
             {
                 SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds, typeof(Gun),
                     (ushort)NetworkMessages.UpdateGunReady);

                 writer.Write(this.Ready);
                 EndNetworkMessage();

                 server_ready = this.Ready;
             }
         }

         [NetworkReceive(NetworkDirections.ToClient, (ushort)NetworkMessages.UpdateGunReady)]
         void Client_ReceiveUpdateGunReady(RemoteEntityWorld sender, ReceiveDataReader reader)
         {
        ...
        private void Server_SendNeedReloadToClient(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds, typeof(Gun),
                    (ushort)NetworkMessages.NeedReloadEventToClient);
        ...
        private bool needReloadMessageReceived;

        public bool NeedReloadMessageReceived
        {
            get { return needReloadMessageReceived; }
        }

        [NetworkReceive(NetworkDirections.ToClient, (ushort)NetworkMessages.NeedReloadEventToClient)]
