...
namespace ProjectEntities
{
    ...
    {
        private static List<WaterPlaneClipVolume> instances = new List<WaterPlaneClipVolume>();

        [FieldSerialize("alwaysShowBorder")]
        private bool alwaysShowBorder;

        ///////////////////////////////////////////

        private WaterPlaneClipVolumeType _type = null; public new WaterPlaneClipVolumeType Type { get { return _type; } }
