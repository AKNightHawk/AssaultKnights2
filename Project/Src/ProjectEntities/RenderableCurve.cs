...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private float overrideRadius = -1;

        [TypeField]
        private RenderableCurvePointType __type = null;
    ...
    public class RenderableCurve : MapCurve
    {
        ...
        [FieldSerialize]
        private RadiusCurveTypes radiusCurveType = RadiusCurveTypes.UniformCubicSpline;
        ...
        [FieldSerialize]
        private int shapeSegments = 12;

        [FieldSerialize]
        private string materialName = "White";

        [FieldSerialize]
        private float textureCoordinatesTilesPerMeter = 1;

        [FieldSerialize]
        private bool collision;

        [FieldSerialize]
        private string collisionMaterialName = "Default";
        ...
        private static long uniqueMeshIdentifier;
        ...
        [TypeField]
        private RenderableCurveType __type = null;
