...
namespace ProjectEntities
{
    ...
    public class MeleeWeaponType : WeaponType
    {
        ...
        public class MeleeWeaponMode : WeaponMode
        {
            ...
            [FieldSerialize]
            [DefaultValue(0.5f)]
            private float kickCheckRadius = .5f;

            [FieldSerialize]
            private string soundKick;
        ...
        [FieldSerialize]
        private MeleeWeaponMode normalMode = new MeleeWeaponMode();

        [FieldSerialize]
        private MeleeWeaponMode alternativeMode = new MeleeWeaponMode();
    ...
    public class MeleeWeapon : Weapon
    {
        ...
        private MeleeWeaponType.MeleeWeaponMode currentFireTypeMode;
        ...
        private MeleeWeaponType _type = null; public new MeleeWeaponType Type { get { return _type; } }
        ...
        private void OnFire(MeleeWeaponType.MeleeWeaponMode typeMode)
        {
            //sound
        ...
        private void Server_SendSoundPlayKickToAllClients(bool alternative)
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(MeleeWeapon),
        ...
        private void Client_ReceiveSoundPlayKick(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
            bool alternative = reader.ReadBoolean();
            if (!reader.Complete())
                return;
