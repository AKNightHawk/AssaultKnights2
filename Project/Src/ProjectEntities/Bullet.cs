...
namespace ProjectEntities
{
    ...
    public class BulletType : DynamicType
    {
        ...
        private MapObjectCreateObjectCollection hitObjects = new MapObjectCreateObjectCollection();
        ...
        //for hit points
        [FieldSerialize]
        private int hitPointMultiplier = 1;

        public int HitPointMultiplier
        {
            get { return hitPointMultiplier; }
            set { hitPointMultiplier = value; }
        }

        [FieldSerialize]
        private int killPointMultiplier = 1;

        public int KillPointMultiplier
        {
            get { return killPointMultiplier; }
            set { killPointMultiplier = value; }
        }

        [FieldSerialize]
        private int assaultCreditMultiplier = 1;

        public int AssaultCreditMultiplier
        {
            get { return assaultCreditMultiplier; }
            set { assaultCreditMultiplier = value; }
        }
    }
    ...
    public class Bullet : Dynamic
    {
        ...
        [FieldSerialize]
        private float damageCoefficient = 1.0f;
        ...
        private BulletType _type = null; public new BulletType Type { get { return _type; } }
        ...
        private void Server_SendHitCallToAllClients(Vec3 hitPosition, string hitShapeBodyName, string hitShapeName, Vec3 hitNormal,
