...
namespace ProjectEntities
{
    ...
    public class Turret : Unit
    {
        ...
        private Vec3 server_shouldSendTurnToPosition = new Vec3(10000, 0, 0);
        private Vec3 server_sentTurnToPosition = new Vec3(10000, 0, 0);
        ...
        private TurretType _type = null; public new TurretType Type { get { return _type; } }
        ...
        private void GunsTryFire(bool alternative)
        {
            foreach (MapObjectAttachedObject attachedObject in AttachedObjects)
            {
                MapObjectAttachedMapObject attachedMapObject = attachedObject as MapObjectAttachedMapObject;
        ...
        private void Server_SendTurnToPositionToClients(IList<RemoteEntityWorld> remoteEntityWorlds,
            Vec3 turnToPosition)
        {
        ...
        private void Client_ReceiveTurnToPosition(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
