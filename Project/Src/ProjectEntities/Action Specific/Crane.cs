...
namespace ProjectEntities
{
    ...
    {
        private CraneType _type = null; public new CraneType Type { get { return _type; } }
        ...
        private Dictionary<Body, int> lastMagnetContactsCount = new Dictionary<Body, int>();

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private List<MagnetObjectItem> magnetAttachedObjects = new List<MagnetObjectItem>();
        ...
        private class MagnetObjectItem
        {
            [FieldSerialize]
        ...
        private void magnetBody_Collision(ref CollisionEvent collisionEvent)
        {
        ...
        private bool IsMagnetBodyAttached(Body body)
        {
        ...
        private void MagnetAttachObject(Body mapObjectBody)
        {
        ...
        private void CreateFixedJointForAttachedObject(MagnetObjectItem item)
        {
        ...
        private void MagnetDetachObject(MagnetObjectItem item)
        {
        ...
        private void MagnetDetachAllObjects()
        {
        again:
            foreach (MagnetObjectItem item in magnetAttachedObjects)
            {
