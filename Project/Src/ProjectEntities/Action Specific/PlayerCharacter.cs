...
namespace ProjectEntities
{
    ...
    {
        [FieldSerialize]
        private Vec3 notAnimatedWeaponAttachPosition;
    ...
    public class PlayerCharacter : GameCharacter
    {
        ...
        private MapObjectAttachedMapObject activeWeaponAttachedObject;
        ...
        private PlayerCharacterType _type = null; public new PlayerCharacterType Type { get { return _type; } }
        ...
        private void CreateActiveWeaponAttachedObject()
        {
        ...
        private void SetActiveNextWeapon()
        {
            if (Weapons.Count == 0)
                return;
        ...
        private void SetActivePreviousWeapon()
        {
            if (Weapons.Count == 0)
                return;
        ...
        protected override void OnPostCreate(bool loaded)
        {
            ...
            if (EngineApp.Instance.ApplicationType != EngineApp.ApplicationTypes.ResourceEditor)
            {
                ...
                {
                    Unit unit = this.GetParentUnit();
                    GiveAllWeapons(unit);//Incin  give all weapons to players
                }
            }
        ...
        private void activeWeapon_PreFire(Weapon entity, bool alternative)
        {
            UpdateTPSArcadeLookDirection();
            UpdatePlatformerDemoLookDirection();
        }

        private void UpdateTPSArcadeLookDirection()
        {
        ...
        private void UpdatePlatformerDemoLookDirection()
        {
        ...
        private void WeaponTryFire(bool alternative)
        {
            if (activeWeapon == null)
                return;
        ...
        private void Server_SendSetActiveWeaponToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceiveActiveWeapon(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void UpdateFirstPersonArmsAttachedMesh(MapObjectAttachedMesh armsAttachedMesh, Camera camera)
        {
