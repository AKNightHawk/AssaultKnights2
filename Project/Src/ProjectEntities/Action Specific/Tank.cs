...
namespace ProjectEntities
{
    ...
    public class TankType : UnitType
    {
        ...
        [FieldSerialize]
        private float driveForwardForce = 80000;

        [FieldSerialize]
        private float driveBackwardForce = 40000;

        [FieldSerialize]
        private float brakeForce = 200000;
        ...
        {
            [FieldSerialize]
            private string wheelBoneName = "";

            [FieldSerialize]
            private string trackBoneName = "";

            [FieldSerialize]
            private float groundHeight = .3f;

            [FieldSerialize]
            private float boneMaxHeightOffset = .2f;

            [FieldSerialize]
            private float wheelAnimationMultiplier = 1;
    ...
    public class Tank : Unit
    {
        ...
        private Vec3 towerBodyLocalPosition;

        private MapObjectAttachedMapObject mainGunAttachedObject;
        private Gun mainGun;
        private Vec3 mainGunOffsetPosition;

        private SphereDir towerLocalDirection;
        private SphereDir needTowerLocalDirection;
        private SphereDir server_sentTowerLocalDirection;

        //currently gears used only for sounds
        private TankType.Gear currentGear;
        ...
        private MeshObject wheelsSkeletonAnimationMeshObject;
        private float wheelsSkeletonAnimationRenderTime;
        private bool wheelsSkeletonAnimationNeedUpdate = true;
        ...
        private TankType _type = null; public new TankType Type { get { return _type; } }
        ...
        private void AddMainGunRecoilForce()
        {
        ...
        private bool GunsTryFire(bool alternative)
        {
            bool fire = false;
        ...
        private void UpdateTowerTransform()
        {
        ...
        private void OnGearChange(TankType.Gear oldGear, TankType.Gear newGear)
        {
            if (!firstTick && Health != 0)
            {
        ...
        private void InitTracksTextureAnimation()
        {
        ...
        private void ShutdownTracksTextureAnimation()
        {
        ...
        private void InitWheelsSkeletonAnimation()
        {
        ...
        private void ShutdownWheelsSkeletonAnimation()
        {
            wheelsSkeletonAnimationMeshObject = null;
        }

        private void WheelsSkeletonAnimationMeshObject_AddToRenderQueue(MovableObject sender,
        ...
        private void UpdateWheelsSkeletonAnimation()
        {
