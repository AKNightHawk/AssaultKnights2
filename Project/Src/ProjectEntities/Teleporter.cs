...
namespace ProjectEntities
{
    ...
    public class TeleporterType : DynamicType
    {
        ...
        [FieldSerialize]
        private float activeAreaHeight = 3;

        [FieldSerialize]
        private float activeAreaRadius = 1;
    ...
    public class Teleporter : Dynamic
    {
        ...
        [FieldSerialize]
        private string changeMapSpawnObjectName = "";
        ...
        private TeleporterType _type = null; public new TeleporterType Type { get { return _type; } }
        ...
        private bool CheckPositionInActiveArea(Vec3 pos)
        {
