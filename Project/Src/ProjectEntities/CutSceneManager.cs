...
namespace ProjectEntities
{
    ...
    public class CutSceneManager : MapGeneralObject
    {
        ...
        private bool cutSceneEnable;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private MapCamera camera;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private MapCameraCurve cameraCurve;

        private float lastTickTime;

        private float oldCameraCurveTime;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private float cameraCurveTime;

        //fading
        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private float fadeCoefficient;

        private enum FadeTask
        {
            None,
            In,
            Out,
        ...
        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private FadeTask fadeTask = FadeTask.None;
        ...
        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private float messageRemainingTime;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private ColorValue messageColor;

        //

        private CutSceneManagerType _type = null; public new CutSceneManagerType Type { get { return _type; } }
        ...
        private float GetCameraCurveInterpolatedTime()
        {
