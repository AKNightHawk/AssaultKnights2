...
namespace ProjectEntities
{
    ...
    {
        private Vec2I index;//network synchronized

        private Mesh mesh;
        private MapObjectAttachedMesh attachedMesh;

        //server side
        private bool serverOrSingle_Moving;

        private const float maxMovingTimeSeconds = 30;
        private float serverOrSingle_movingTime;
        private UserManagementServerNetworkService.UserInfo server_movingByUser;

        //client side
        private UserManagementClientNetworkService.UserInfo client_movingByUser;

        //

        private JigsawPuzzlePieceType _type = null; public new JigsawPuzzlePieceType Type { get { return _type; } }
        ...
        private void CreateAttachedMesh()
        {
        ...
        private void DestroyAttachedMesh()
        {
        ...
        private void Server_SendIndexToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Server_SendPositionToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds,
        ...
        private void ClientOrSingle_SoundPlay(string soundName)
        {
