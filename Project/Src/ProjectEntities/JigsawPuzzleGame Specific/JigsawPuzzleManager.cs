...
namespace ProjectEntities
{
    ...
    public class JigsawPuzzleManager : MapGeneralObject
    {
        ...
        private Vec2I pieceCount;//network synchronized

        private JigsawPuzzleManagerType _type = null; public new JigsawPuzzleManagerType Type { get { return _type; } }

        private MeshObject backgroundImageMeshObject;
        private SceneNode backgroundImageSceneNode;
        ...
        private void ServerOrSingle_SetPieceCount(Vec2I pieceCount)
        {
        ...
        private void ServerOrSingle_GeneratePuzzles(Vec2I pieceCount)
        {
            ServerOrSingle_DestroyPuzzles();
        ...
        private void Server_SendPieceCountToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
        ...
        private void Client_ReceivePieceCount(RemoteEntityWorld sender, ReceiveDataReader reader)
        {
        ...
        private void ServerOrSingle_CreatePiece(Vec2I index)
        {
        ...
        private void ServerOrSingle_DestroyPuzzles()
        {
        ...
        private void CreateBackgroundImageMeshObject()
        {
        ...
        private void DestroyBackgroundImageMeshObject()
        {
            if (backgroundImageMeshObject != null)
            {
