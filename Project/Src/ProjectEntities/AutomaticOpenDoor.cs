...
namespace ProjectEntities
{
    ...
    {
        private const float automaticOpenDistanceDefault = 3.0f;

        [FieldSerialize]
        [DefaultValue(automaticOpenDistanceDefault)]
        private float automaticOpenDistance = automaticOpenDistanceDefault;

        private const float automaticOpenCloseLatencyDefault = 1;

        [FieldSerialize]
        [DefaultValue(automaticOpenCloseLatencyDefault)]
        private float automaticOpenCloseLatency = automaticOpenCloseLatencyDefault;
    ...
    {
        [FieldSerialize]
        private bool noAutomaticOpen;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private float needCloseRemainingTime;

        [FieldSerialize(FieldSerializeSerializationTypes.World)]
        private float nextCheckRemainingTime;

        //

        private AutomaticOpenDoorType _type = null; public new AutomaticOpenDoorType Type { get { return _type; } }
