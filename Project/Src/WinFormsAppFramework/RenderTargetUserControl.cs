...
namespace WinFormsAppFramework
{
    public partial class RenderTargetUserControl : UserControl
    {
        ...
        private bool needCreateRenderWindow;
        private bool allowCreateRenderWindow = true;
        ...
        //keys
        private Set<Keys> keys = new Set<Keys>();
        ...
        private bool GetEKeyByKeyCode(Keys keyCode, out EKeys eKey)
        {
        ...
        private EMouseButtons GetEMouseButtonByMouseButton(MouseButtons button)
        {
